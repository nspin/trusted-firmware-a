...
#define NS_DRAM1_BASE			0x80000000
#define NS_DRAM1_SIZE			0x3de00000
...
#define BL32_NS_DRAM_BASE		NS_DRAM1_BASE
#define BL32_NS_DRAM_LIMIT		(NS_DRAM1_BASE + NS_DRAM1_SIZE)
...
#elif BL32_RAM_LOCATION_ID == NS_DRAM_ID
# define BL32_MEM_BASE			NS_DRAM1_BASE
# define BL32_MEM_SIZE			NS_DRAM1_SIZE
# define BL32_BASE			BL32_NS_DRAM_BASE
# define BL32_LIMIT			BL32_NS_DRAM_LIMIT
#else
...
#define PLATFORM_G1S_PROPS(grp)						\
	...
	INTR_PROP_DESC(QEMU_IRQ_SEC_SGI_7, GIC_HIGHEST_SEC_PRIORITY,	\
					   grp, GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(0x1d, GIC_HIGHEST_SEC_PRIORITY,	\
					   grp, GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(0x28, GIC_HIGHEST_SEC_PRIORITY,	\
					   grp, GIC_INTR_CFG_LEVEL), \
	INTR_PROP_DESC(0x4e, GIC_HIGHEST_SEC_PRIORITY,	\
					   grp, GIC_INTR_CFG_EDGE), \
	INTR_PROP_DESC(0x4f, GIC_HIGHEST_SEC_PRIORITY,	\
					   grp, GIC_INTR_CFG_EDGE)
